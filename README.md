...
Fork of [web3dart](https://pub.dartlang.org/packages/web3dart) with added support for celo `type 123` transactions. This allows for paying transaction fees using fee currencies on the Celo blockchain.
