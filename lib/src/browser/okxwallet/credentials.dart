...
class OkxWalletCredentials extends CredentialsWithKnownAddress implements CustomTransactionSender {
  @override
  final EthereumAddress address;
  final OkxWallet okxWallet;

  OkxWalletCredentials(String hexAddress, this.okxWallet) : address = EthereumAddress.fromHex(hexAddress);

  @override
  Future<MsgSignature> signToSignature(Uint8List payload, {int? chainId, bool isEIP1559 = false}) {
    throw UnsupportedError('Signing raw payloads is not supported on OkxWallet');
  }
